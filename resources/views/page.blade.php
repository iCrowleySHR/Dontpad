    ...
    <section class="mx-auto px-1">
        ...
        <div class="relative">
            <textarea id="content" spellcheck="false"
                class="w-full resize-none outline-none p-1 overflow-hidden rounded-lg min-h-[96vh] border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-transparent shadow-md transition duration-200"
